                ...
                <div class="card-body p-3 p-sm-4">
                    ...
                    <div class="deposit-preview">
                        ...
                        <div class="deposit-content">
                            ...
                            <a href="{{ route('user.deposit.confirm') }}" class="btn btn--base btn--md w-100 radius-5 mt-3 ">@lang('Checkout')</a>

                            @else

                            <a href="{{ route('user.deposit.manual.confirm') }}" class="btn btn--base btn--md w-100 radius-5 mt-3 ">@lang('Checkout')</a>
